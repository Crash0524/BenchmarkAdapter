...
Follow the official WebArena tutorial and execute the setup scripts in numerical order. Before running any script, make sure the website URLs inside the corresponding script files are updated to match your local environment.
