...
4. Response Conciseness: The response must be as brief as possible. Avoid any unnecessary explanations, redundant descriptions, or conversational filler. Get straight to the point to ensure the output length is strictly controlled.
